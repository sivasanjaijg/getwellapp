...
import 'package:flutter_health_care_app/notifi.dart';
  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Make Your Appointment", style: TextStyles.h1Style),
      ],
    ).p16;
  }
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          suffixIcon: SizedBox(
            width: 50,
            child:
                Icon(Icons.search, color: LightColor.skyBlue).alignCenter.ripple(
                      () {},
      ...
      children: <Widget>[
        ...
        SizedBox(
          ...
          ListView(
            ...
            children: <Widget>[
TextButton(child: _categoryCardWidget(
  "Chemist & Drugist",
  "96 Stores",
        ...
        children: [
          const DrawerHeader(
            ...
            child: UserAccountsDrawerHeader(
              ...
              accountEmail: Text("getwellsoon69@gmail.com"),
